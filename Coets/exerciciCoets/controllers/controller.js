...
var arrayThrusters = new Array(); //Array de propulsors de cada coet
function newRocket() {
...
function accelerateUp(event) {
    ...
    console.log(a);
    var powerTest = 10; // potència q augmenta o disminueix cada cop
    var actualSpeed = 0; //Velocitat actual que enviem als 3 propulsors
    var i;
    var j;
    for (i = 0; i < arrayRockets.length; i++) {
